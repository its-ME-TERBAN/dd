...
TOKEN = os.environ.get("8137482921:AAHD8m3E20WQoCMuVC_aakD4deq_WSbqKgU")

# Bot owner/admin information
ADMIN_ID = int(os.environ.get("5786411100", "5786411100"))
BOT_USERNAME = os.environ.get("@Ravanbrother_Bot", "@YAMRAJ_PAPA12")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    watermark = f"📌 @YAMRAJ_PAPA12 | {datetime.now().strftime('%Y-%m-%d')}"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if query.data == "main_menu":
        ...
        await query.message.edit_text(
            ...
            f"This bot is created by @YAMRAJ_PAPA12\n\n"
            f"Features:\n"
